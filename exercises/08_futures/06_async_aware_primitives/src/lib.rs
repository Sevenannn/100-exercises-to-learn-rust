...
///
/// The response_channel is synchronous
/// Response_channel.send blocks until the response_receiver in ping ready to receive message
/// Response_receiver in ping is never ready because it's still waiting for pong to complete
